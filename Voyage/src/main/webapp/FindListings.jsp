...
<nav class="navbar">
  <div class="nav-center">
    ...
    <ul class="nav-links" id="nav-links">
      ...
      <li><a href="findlistings" class="nav-link active">Listings</a></li>
    ...
    <c:forEach items="${listingsWithMinPrices}" var="lstWithMP">
      ...
      <article class="listing-card">
        <div class="listing-img-container">
          <a href="<c:out value='${lstWithMP.getListing().getListingURL()}'/>">
            <img
                    class="listing-img"
        ...
        <div class="listing-footer">
          <p class="listing-title">
            <a href="hostlistings?hostid=<c:out value='${lstWithMP.getListing().getHosts().getHostId()}'/>">
              <img
                      class="host-img"
            ...
            <span><c:out value="${lstWithMP.getListing().getName()}"/></span>
          </p>

          <div class="listing-info">
            <p class="listing-nbhood">
              <span><i class="fas fa-map"></i></span>
              <c:out value="${lstWithMP.getListing().getNeighborhoods().getName()}"/>
            </p>

            <div class="listing-details">
              <p>⭐ <c:out value="${lstWithMP.getListing().getReviewScore()}" /></p>
              <p>
